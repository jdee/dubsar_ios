...
- (void)testHelp
{
    ...
    [self singleHelpCase:@"instance hyponym" expected:@"instances of this class"];
    ...
    [self singleHelpCase:@"attribute" expected:@"general qualities"];
    ...
    [self singleHelpCase:@"domain of synset (region)" expected:@"relevant regions"];
    ...
    [self singleHelpCase:@"entailment" expected:@"consequences"];
    [self singleHelpCase:@"cause" expected:@"origins or reasons"];
