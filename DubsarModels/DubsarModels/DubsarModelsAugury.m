...
#import "DubsarModelsAugury.h"
#import "DubsarModelsDatabaseWrapper.h"
#import "DubsarModelsWord.h"

@implementation DubsarModelsAugury

+ (instancetype) augury
{
    return [[DubsarModelsAugury alloc] init];
}
...
- (DubsarModelsWord*)randomVerb
{
    ...
    DubsarModelsWord *word = [DubsarModelsWord wordWithId:verbId name:nil partOfSpeech:DubsarModelsPartOfSpeechVerb];
...
{
    DubsarModelsWord* word = [self randomVerb];
