...
static DubsarModelsPointerDictionary* theDictionary = nil;

@implementation DubsarModelsPointerDictionary
...
{
    return [[DubsarModelsPointerDictionary instance]helpWithPointerType:ptype];
}

+ (NSString*)titleWithPointerType:(NSString *)ptype
{
    return [[DubsarModelsPointerDictionary instance]titleWithPointerType:ptype];
}

+ (DubsarModelsPointerDictionary*)instance
{
    if (theDictionary == nil) {
        theDictionary = [[DubsarModelsPointerDictionary alloc]init];
    }
