...
- (void)setupHelpDictionary
{
    ...
    [helpDictionary setValue:@"instance of this class" forKey:@"instance hyponym"];
    ...
    [helpDictionary setValue:@"general quality" forKey:@"attribute"];
    ...
    [helpDictionary setValue:@"relevant region" forKey:@"domain of synset (region)"];
    ...
    [helpDictionary setValue:@"consequence" forKey:@"entailment"];
    [helpDictionary setValue:@"origin or reason" forKey:@"cause"];
