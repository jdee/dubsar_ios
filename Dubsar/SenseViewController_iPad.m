...
- (void)followTableLink:(NSIndexPath *)indexPath
{
    ...
    if ([_linkType isEqualToString:@"sense"]) {
        ...
        [self.navigationController pushViewController:[[SynsetViewController_iPhone alloc]initWithNibName:@"SynsetViewController_iPad" bundle:nil synset:targetSynset] animated:YES];
    }
#endif
}
